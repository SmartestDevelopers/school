...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Mark Challan as Paid</div>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    <form action="{{ route('challan.mark-paid', $challan->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="student_id" id="student_id" class="form-control" required>
                                <option value="{{ $challan->student_id }}" selected>{{ $challan->full_name }} (Roll: {{ $challan->gr_number }})</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary">CHALLAN PAID</button>
                    </form>
                </div>
            </div>
        </div>
